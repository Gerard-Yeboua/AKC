...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/hero-carousel/logo_akc.png" rel="icon">
          ...
          <div class="col-lg-7">
            ...
            <div class="our-story">
              ...
              <div class="watch-video d-flex align-items-center position-relative">
                ...
                <a href="assets/video/video3.mp4" class="glightbox stretched-link">Lire la Video</a>
              </div>
              <div class="watch-video d-flex align-items-center position-relative">
                <i class="bi bi-play-circle"></i>
                <a href="assets/video/video1.mp4" class="glightbox stretched-link">Lire la Video</a>
              </div>
              <div class="watch-video d-flex align-items-center position-relative">
                <i class="bi bi-play-circle"></i>
                <a href="assets/video/video2.mp4" class="glightbox stretched-link">Lire la Video</a>
              </div>
            </div>
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card-item">
              <div class="row">
                <div class="col-xl-12">
                <a href="genie_civil.php"><div class="card-bg" style="background-image: url(assets/img/hero-carousel/Geniecivil.jpg);" data-aos="zoom-in" data-aos-delay="100"></div></a>
                </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card-item">
              <div class="row">
                <div class="col-xl-12">
                <a href="environnement.php"> <div class="card-bg" style="background-image: url(assets/img/hero-carousel/environment.jpg);" data-aos="zoom-in" data-aos-delay="100"></div></a>
                </div>
                <div class="col-xl-12 d-flex align-items-center">
                  <div class="card-body">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card-item">
              <div class="row">
                <div class="col-xl-12">
                <a href="energie.php"><div class="card-bg" style="background-image: url(assets/img/hero-carousel/energie2.jpg);" data-aos="zoom-in" data-aos-delay="100"></div></a>
                </div>
                <div class="col-xl-12 d-flex align-items-center">
                  <div class="card-body">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card-item">
              <div class="row">
                <div class="col-xl-12">
                <a href="travaux_public.php"><div class="card-bg" style="background-image: url(assets/img/hero-carousel/Travaux-Public-Couverture_1~2.jpg);" data-aos="zoom-in" data-aos-delay="100"></div></a>
                </div>
                <div class="col-xl-12 d-flex align-items-center">
                  <div class="card-body">
    ...
    <section id="team" class="team">
      <div class="container" data-aos="fade-up"><br>
        ...
        <div class="section-header">
          ...
          <img src="assets/img/blog/AKC_SARL.png" alt="Organigramme" width="1000" height="500"><br>
          <img src="assets/img/blog/Image4_.png" alt="Organigramme 2" width="1300" height="250">
        </div>
        <div class="row gy-10">
        ...
        <div class="section-header">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="100">
            <div class="member-img">
              <img src="assets/img/team/Directeur-general~2.jpg" class="img-fluid" alt="">
              <div class="social">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="200">
            <div class="member-img">
              <img src="assets/img/team/femme_avatar.jpg" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="300">
            <div class="member-img">
              <img src="assets/img/team/homme_avatar.png" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="400">
            <div class="member-img">
              <img src="assets/img/team/Cisse_siaka.jpg" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="500">
            <div class="member-img">
              <img src="assets/img/team/Assistant-DAF~2.jpeg" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="700">
            <div class="member-img">
              <img src="assets/img/team/Directeur-technique~2.jpg" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="800">
            <div class="member-img">
              <img src="assets/img/team/Commercial-2~2.png" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="700">
            <div class="member-img">
              <img src="assets/img/team/Directeur-commercial~3.jpg" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="700">
            <div class="member-img">
              <img src="assets/img/team/Directeur-informatique&communication~2.jpg" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="900">
            <div class="member-img">
              <img src="assets/img/team/Informaticien-1~2.jpeg" class="img-fluid" alt="">
              <div class="social">
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="800">
            <div class="member-img">
              <img src="assets/img/team/Informaticien-2~2.jpeg" class="img-fluid" alt="">
              <div class="social">
                <a href="#"><i class="bi bi-twitter"></i></a>
                <a href="#"><i class="bi bi-facebook"></i></a>
                <a href="#"><i class="bi bi-instagram"></i></a>
          ...
          <div class="col-lg-4 col-md-6 member" data-aos="fade-up" data-aos-delay="900">
            <div class="member-img">
              <img src="assets/img/team/DAF~2.jpg" class="img-fluid" alt="">
              <div class="social">
                <a href="https://www.twitter.com/gerardkra@"><i class="bi bi-twitter"></i></a>
                <a href="https://www.facebook.com/profile.php?id=100091909403723"><i class="bi bi-facebook"></i></a>
                <a href="https://www.instagram.com/gerard.yeboua.7"><i class="bi bi-instagram"></i></a>
